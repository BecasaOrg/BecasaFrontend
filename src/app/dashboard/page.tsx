    ...
    const renderCampamentos = () => {
        ...
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                {camps.map((camp: Camp) => (
                    <div onClick={() => console.log(camp)} key={camp.id} className="group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all cursor-pointer">
